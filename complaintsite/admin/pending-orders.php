...
?>										
										<tr>
											...
											<td>   <a href="javascript:void(0);" onClick="popUpWindow('http://localhost/shopping/admin/updateorder.php?oid=<?php echo htmlentities($row['id']);?>');" title="Update order"><i class="icon-edit"></i></a>
											</td>
											</tr>
